...
public class Room extends Scene {
  ...
  public SGNode get_scene_graph(){
    ...
    Shader shader = new Shader(gl, "vs_tt.txt", "fs_multi_light.txt");
    ...
    // Floor
    twoTriangles = new Model(gl, camera, lights, directionLights, shader, material, modelMatrix, mesh, floorTextureId);
    ...
    // Walls
    twoTriangles = new Model(gl, camera, lights, directionLights, shader, material, modelMatrix, mesh, wallTextureId);
    ...
    // Window
    shader = new Shader(gl, "vs_tt.txt", "fs_multi_light.txt");
    twoTriangles = new Model(gl, camera, lights, directionLights, shader, material, modelMatrix, mesh, windowTextureId);
